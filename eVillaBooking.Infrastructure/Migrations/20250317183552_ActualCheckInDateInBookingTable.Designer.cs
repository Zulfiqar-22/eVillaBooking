...
namespace eVillaBooking.Infrastructure.Migrations
{
    ...
    [Migration("20250317183552_ActualCheckInDateInBookingTable")]
    partial class ActualCheckInDateInBookingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eVillaBooking.Domain.Entity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eVillaBooking.Domain.Entity.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("eVillaBooking.Domain.Entity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eVillaBooking.Domain.Entity.Booking", b =>
                {
                    b.HasOne("eVillaBooking.Domain.Entity.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
